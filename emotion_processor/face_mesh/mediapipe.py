...
class FaceMeshMediapipe:
    ...
    def extract_face_mesh_points(self, face_image: np.ndarray, face_mesh_info: Any, viz: bool) -> list:
        ...
        for face_mesh in face_mesh_info.multi_face_landmarks:
            ...
            if viz:
                self.mp_draw.draw_landmarks(face_image, face_mesh, self.face_mesh_object.FACEMESH_TESSELATION, self.config_draw)
    ...
    def main_process(self, face_image: np.ndarray) -> Tuple[dict, dict, dict, dict, str, np.ndarray]:
        ...
        if face_mesh_check is False:
            return (self.eye_brows_points, self.eyes_points, self.nose_points, self.mouth_points, 'NO FACE MESH', original_image)
        else:
            ...
            return (self.eye_brows_points, self.eyes_points, self.nose_points, self.mouth_points, 'FACE MESH', original_image)
